...
export const BreadcrumbWraper = (props) => {
...
export const BreadcrumbSingle = (props) => {

    const { id_unidade, nm_unidade, id_unidade_pai, nm_unidade_pai, cd_tipo_unidade, nm_tipo } = props.filter;
