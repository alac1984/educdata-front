...
import { StateInfo } from '../content/element/widget';
...
const ReportMunicipio = (props) => {
    ...
    const showEstInfo = useSelector(state => state.selectedUnidade.showEstInfo)
                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-4">
                            <div className="widget atbd_widget widget-card">
                                ...
                                <StateInfo name='Fortaleza' type='Município' address='' phone='' />
                            </div>
                            {/* end seller info */}
